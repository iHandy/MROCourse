 ...
 */
public class SpacesInRowsGystogramView extends View {
    ...
    public SpacesInRowsGystogramView(Context context) {
        super(context);
        init(null, 0);
    }

    public SpacesInRowsGystogramView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public SpacesInRowsGystogramView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mGystogram != null) {
            int space = (contentHeight-20) / 30/*mGystogram.size()*/;
            ...
            for (GystMember gystMember : mGystogram) {
                ...
                canvas.drawLine(40, y, value / coef + 40, y, mPaint);
                //canvas.save();
                //canvas.rotate(90);
                canvas.drawText(String.valueOf(gystMember.grayValue), 0, y, mTextPaint);
                //canvas.rotate(-90);
                //canvas.restore();
                y += space;
                iter++;
